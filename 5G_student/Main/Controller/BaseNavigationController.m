...
{
    BOOL hiddenNavBar = [viewController isKindOfClass:[NSClassFromString(@"LoginViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"HomeViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"CourseDetailViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"TeacherDetailViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"MineViewController") class]];
